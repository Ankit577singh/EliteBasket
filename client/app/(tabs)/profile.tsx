...
export default function Profile() {
    const { user } = { user: dummyUser } // Replace with actual auth
            ...
            >
                {!user ? (
                    ...
                    <View className='items-center w-full'>
                        ...
                        <Text className="text-secondary text-base mb-8 text-center px-4">
                        ...
                        <View className='bg-white rounded-xl border border-gray-100/75 p-2 mb-4'>
                            {PROFILE_MENU.map((item, index) => (
                                ...
                                >
                                    ...
                                    <Text className='flex-1 text-primary font-medium text-base'>
                                        {item.title}
                                    </Text>

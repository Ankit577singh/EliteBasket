...
export default function Home() {
  ...
  return (
    <SafeAreaView className='flex-1' edges={['top']}>
      <Header title='EliteBasket' showMenu showCart showLogo showSearch></Header>
              ...
              <View className='flex-row justify-between items-center mb-4'>
               ...
               <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                    ...
                    <CategoryItem key={cat.id} item={cat} isSelected={false}
                      onPress={()=> router.push({pathname: '/shop',params: {category : cat.id === 'all'? '': cat}})}
                    />
                    ))}
              </ScrollView>
        </View>
      ...
      <View className='mb-8'>
            <View className='flex-row justify-between items-center mb-4'>
             ...
             <TouchableOpacity onPress={()=>router.push('/shop')}>
                     <Text className='text-secondary texts-sm'>See All</Text>
             </TouchableOpacity>
            </View>
